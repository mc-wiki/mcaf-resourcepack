...
[Deutsch](README.de.md) | [English](README.md) | [日本語](README.ja.md) | [文言](README.lzh.md) | [Português](README.pt-br.md) | 简体中文 | [繁體中文](README.zh-hant.md)
...
本项目的翻译工作在 [Crowdin](https://crowdin.com/project/mcaf-resourcepack) 上进行。
...
| `sk_sk`  | 斯洛伐克语   | Slovenčina (Slovensko) | <img src="badges/sk_sk.png"> | 32% | 5% |
...
可[在此处提交 issue](https://github.com/mc-wiki/mcaf-resourcepack/issues/new?template=request_new_language.yml) 申请新语言。

## 如何使用

1. 前往[最新 Release](https://github.com/mc-wiki/mcaf-resourcepack/releases/latest) 页面（每3小时同步）或 [Modrinth](https://modrinth.com/resourcepack/april-fools-translation)（每周同步）。
2. 下载所需语言的资源包。
3. 安装到你的游戏中。
...
欢迎在 Crowdin 上完善翻译：https://crowdin.com/project/mcaf-resourcepack

## 常见问题

**Q1：游戏内出现未翻译文本怎么办？**

A1：请到 [Crowdin](https://crowdin.com/project/mcaf-resourcepack) 参与贡献。如果 Crowdin 上也没有该文本，通常为硬编码，资源包无法修复。

**Q2：游戏内出现本地化键名（如`rule.food_restriction.air_block`）怎么办？**

A2：通常是语言文件缺失。请在 [GitHub Issues](https://github.com/mc-wiki/mcaf-resourcepack/issues) 反馈。
